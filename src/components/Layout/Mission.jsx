    ...
    <div className="bg-[#1C1C1C] w-full h-full">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-8">
          ...
          <div className="card">
            <div className="content-box">
              ...
              <p className="card-content">
                Frontend for a bakery, where users customize online.
              </p>
              <a
                className="see-more"
        ...
        <div className="parent">
          <div className="card">
            <div className="content-box">
              <span className="card-title">Content Management System(CMS)</span>
              <p className="card-content">
                A Content Management System (CMS) allows administrators to
                upload, update, and manage digital content such as documents,
                images, and videos in one centralized platform. It also includes
                features for organizing voting schedules, managing events, and
                assigning or tracking tasks efficiently.
              </p>
              <a
                className="see-more"
                href="https://niki-app.vercel.app/"
                alt="niki"
              >
                <span>Visit</span>
              </a>
            ...
            <div className="date-box">
              <span className="month">February 2026 -March 2026</span>
            </div>
          </div>
        </div>
        {/* 4 */}
